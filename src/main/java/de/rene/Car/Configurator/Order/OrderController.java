...
public class OrderController {
    ...
    @PostMapping("/")
    public Order addConfig(Order configuration) {
        Order config = repository.insert(configuration);
        return config;
    }
    @PutMapping("/")
    public Order updateConfig(Order configuration) {
        Order config = repository.insert(configuration);
        return config;
    }
    @DeleteMapping("/{id}")
    ...
    public List<Order> getAll() {
        List<Order> configurations = repository.findAll();
